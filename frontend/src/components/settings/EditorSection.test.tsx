...
describe("EditorSection", () => {
  ...
  it("commits 3000 on blur, preserving other editor fields (proves spread, not replacement)", async () => {
    ...
    expect(saved.editor.fontSize).toBe(config.editor.fontSize);
    expect(saved.editor.lineHeight).toBe(config.editor.lineHeight);
  });
