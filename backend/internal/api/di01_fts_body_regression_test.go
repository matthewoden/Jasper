...
func TestDI01_InteractiveSavesKeepBodyFTS(t *testing.T) {
	...
	t.Run("update", func(t *testing.T) {
		...
		hits, err := idx.SearchFTS(ctx, "zqxbodyupdate", nil, 10, "relevance")
		if err != nil {
	...
	t.Run("create", func(t *testing.T) {
		...
		hits, err := idx.SearchFTS(ctx, "zqxbodycreate", nil, 10, "relevance")
		if err != nil {
			t.Fatalf("SearchFTS: %v", err)
		}
		if len(hits) == 0 {
	...
	t.Run("move", func(t *testing.T) {
		...
		hits, err := idx.SearchFTS(ctx, "zqxbodymove", nil, 10, "relevance")
		if err != nil {
			t.Fatalf("SearchFTS: %v", err)
		}
		if len(hits) == 0 {
